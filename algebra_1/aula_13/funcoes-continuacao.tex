...
\begin{document}
    ...
    \begin{frame}
        ...
        Agora, $y \in B$, \pause $(f\circ f^{-1})(y) \pause = f(f^{-1}(y)) \pause = y \pause = i_{B}(y)$. \pause E se $x \in A$, \pause $(f^{-1}\circ f)(x) = \pause f^{-1}(f(x)) \pause = x \pause = i_{A}(x)$. \pause Portanto $f\circ f^{-1} = \pause i_{B}$ \pause e $f^{-1}\circ f = \pause i_{A}$ como quer{\'\i}amos.\pause \hspace{.5cm} \qedsymbol
    \end{frame}
