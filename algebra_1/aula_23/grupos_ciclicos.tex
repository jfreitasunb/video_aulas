    ...
    \begin{frame}
        ...
        \begin{proposicao}
            ...
            \begin{enumerate}[label={\arabic*})]
                ...
                \item Se $H$ \'e um subgrupo de $G$ \pause tal que $a \in H$, \pause ent\~ao $[a] \subset H$.\pause
            \end{enumerate}
        \end{proposicao}
    \end{frame}
    ...
    \begin{frame}
        \begin{definicao}
            ...
            \[
                G = [x]. \pause
            \]
            Nessas condi\c{c}\~oes, o elemento $x$  \pause \'e chamado de \textbf{gerador} do grupo $G$.\pause
        \end{definicao}
    \end{frame}
